...
const PricingForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center flex-col makejustify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-4 px-1 md:py-8 md:px-2 overflow-auto pb-24">
      {/* Tabs */}
      <div className="w-full max-w-3xl mb-6 sticky top-0 z-30 bg-transparent">
        <div className="flex w-full bg-gray-100 rounded-lg shadow border border-gray-200 overflow-hidden">
          <button
            className={`flex-1 py-2 text-base sm:text-lg font-semibold transition-colors focus:outline-none px-1 sm:px-2 rounded-lg m-1 ${
              activeTab === 'details'
      ...
      <div className="w-full max-w-3xl bg-white/50 backdrop-blur-lg border border-white/30 rounded-2xl md:rounded-3xl shadow-2xl p-3 sm:p-4 md:p-8 md:py-12">
        ...
        <div className="w-full max-w-3xl">
          <BillPreview priceFields={priceValues} wireFields={wiresValues} />
        </div>
      )}
    </div>
  );
